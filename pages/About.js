        ...
        <div className='images-meaning'>
          ...
          <div className='img-2'>
            ...
            <div className='textMeaning-2'>
              ...
              property, money, wealth, assets, riches, property and valuables.​
            </div>
          </div>
        </div>
      </div>
      <div className='ourStory'>
        ...
        <div className='events'>
          ...
          <div className='event'>
            ...
            <div className='content'>
              Early work on the algorithmic financial mathematic engine started
              in late 2002. At the time the draft models were kept private as
              the efficient cloud-based technology to bring this to being was
              not readily accepted by the public or the financial services
              industry.
            </div>
          </div>{' '}
          <div className='event'>
